#!/bin/bash
#SBATCH --job-name=phase2_weights
...
#SBATCH --gres=gpu:1
#SBATCH --tmp=50G
#SBATCH --output=phase2_weights_%j.out
#SBATCH --error=phase2_weights_%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=srobaina99@gmail.com

# ============================================================
# Phase 2 weight factor sweep (4 models × 7 weights × 25 prompts).
# Submit: sbatch scripts/clusteruy/run_phase2_weights.sh
